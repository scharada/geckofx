...
namespace Skybound.Gecko
{
	...
	{
		private GeckoWindow(nsIDOMWindow2 window)
		{
			_DomWindow = window;
		}
		...
		nsIDOMWindow2 _DomWindow;
		
		internal static GeckoWindow Create(nsIDOMWindow2 window)
		{
		...
		{
			get { return GeckoWindow.Create((nsIDOMWindow2)_DomWindow.GetParent()); }
		}
		...
		{
			get { return GeckoWindow.Create((nsIDOMWindow2)_DomWindow.GetTop()); }
		}
